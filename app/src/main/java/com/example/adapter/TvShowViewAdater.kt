...
import coil.load
import com.example.movie_app.databinding.TvshowLayoutBinding
import com.example.movie_app.models.TvShowResponseItem

class TvShowViewAdater : RecyclerView.Adapter<TvShowViewAdater.MyViewHolder>() {
    inner class MyViewHolder(val binding:TvshowLayoutBinding):
